  ...
  activateWorker() {
    ...
    if (cluster.isMaster) {
      setInterval(function () {
        clientRedis.mgetAsync('sisyphe:totalGeneratedTask', 'sisyphe:totalPerformedTask', 'sisyphe:totalFailedTask').then((values) => {
          ...
          if (+metrics.totalGeneratedTask && totalJobs >= +metrics.totalGeneratedTask) {
            ...
            callFinishers().then(() => {
              ...
              clientRedis.del('sisyphe:totalGeneratedTask', 'sisyphe:totalPerformedTask', 'sisyphe:totalFailedTask');
              clearInterval(this);
            }).catch((error) => {
  ...
  initializeStarter() {
    ...
    return fs.accessAsync(pathToStarterModule).then(() => {
      ...
      this.starterModule.setFunctionEventOnEnd(() => {
        ...
        clientRedis.set("sisyphe:totalGeneratedTask", this.starterModule.totalFile);
        console.log('');
